...
//		wp_enqueue_style('tuner', TUNER_DIR_URL . 'assets/css/style.css' );
//		wp_enqueue_script('tuner', TUNER_DIR_URL . 'assets/js/script.js', '', '', true );
	}
	...
	public function register_admin_menus() {
		...
		add_submenu_page(
			...
			'manage_options',
			'payments-history',
//			'stripe_builder_payments_history_view',
	...
	public function cashier_api_settings_html() {
		include_once CASHIER_DIR_PATH . "templates/admin/partials/api-settings.php";
	}
	...
	function cashier_payments_history_view() {
		include_once CASHIER_DIR_PATH . "templates/admin/partials/payments-history-view.php";
	}
